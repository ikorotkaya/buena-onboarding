describe("Onboarding Flow", () => {
  it("should navigate through the onboarding flow", () => {
    ...
    cy.get("h2").should("contain.text", "Welcome to Buena");
    ...
    cy.get("h2").should("contain.text", "What is your full name?");
    ...
    cy.get("h2").should("contain.text", "What is your email?");
    cy.get("input").should("have.value", "");
    cy.get(`[data-testid="input-error"]`).should("not.exist");
    cy.get(`[data-testid="next-button"]`).should("contain.text", "Next");
    cy.get(`[data-testid="next-button"]`).should(
    ...
    cy.get("h2").should("contain.text", "What is your phone number?");
    cy.get("input").should("have.value", "");
    cy.get(`[data-testid="input-error"]`).should("not.exist");
    cy.get(`[data-testid="next-button"]`).should("contain.text", "Next");
    cy.get(`[data-testid="next-button"]`).should(
    ...
    cy.get("h2").should("contain.text", "What is your income?");
    ...
    cy.get("h2").should("contain.text", "Check your info:");
    ...
    cy.get("h2").should("contain.text", "Thank you for your submission!");
